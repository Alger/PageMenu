...
class MenuItemView: UIView {
    ...
    func setUpMenuItemView(_ menuItemWidth: CGFloat, menuScrollViewHeight: CGFloat, indicatorHeight: CGFloat, separatorPercentageHeight: CGFloat, separatorWidth: CGFloat, separatorRoundEdges: Bool, menuItemSeparatorColor: UIColor, hideMenuItemSeparator: Bool) {
        ...
        menuItemSeparator!.isHidden = hideMenuItemSeparator
    ...
    func configure(for pageMenu: CAPSPageMenu, controller: UIViewController, index: CGFloat) {
        ...
        /* // It's controled by configuraition hideMenuItemSeparator for now
        if pageMenu.configuration.useMenuLikeSegmentedControl {
